            ...
            <div class="unified-page">
                <div class="unified-wrap">
                    ...
                    <section class="surface">
                        ...
                        <div class="link-row">
                            <button class="link-button" @click=${() => this._open('https://keycompanion.vercel.app')}>Website</button>
                            <button class="link-button" @click=${() => this._open('https://keycompanion.vercel.app/admin')}>Admin Portal</button>
                        </div>
                    </section>
